...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nr.optional-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13602&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nr.optional-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nr.optional` can be installed with:

```
conda install nr.optional
```

It is possible to list all of the versions of `nr.optional` available on your platform with:
